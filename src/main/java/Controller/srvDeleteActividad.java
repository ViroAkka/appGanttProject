...
public class srvDeleteActividad extends HttpServlet {
...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet srvDeleteActividad</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet srvDeleteActividad at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
        }
    }
