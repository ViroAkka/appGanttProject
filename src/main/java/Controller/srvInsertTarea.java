...
public class srvInsertTarea extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if ("POST".equalsIgnoreCase(method)) {
                ...
                int respuesta = tareaService.getSrvTareaPort()
                                  .insertTarea(idProyecto, nombre, descripcion, fechaInicio, fechaFinalizacion);
                ...
                response.sendRedirect("newTarea.jsp");
                } 
            else 
            {
                // Si es GET simplemente mostramos la página
                RequestDispatcher rd = request.getRequestDispatcher("newTarea.jsp");
...
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>ID Proyecto: " + idProyecto + "Nombre: " + nombre + ", descripción: " + descripcion + ", fecha Inicio: " + fechaInicio + ", fecha fin: " + fechaFinalizacion +"</h1>");
//            out.println("</body>");
//            out.println("</html>");
        }
    }
