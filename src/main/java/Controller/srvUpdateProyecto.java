...
public class srvUpdateProyecto extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if ("POST".equalsIgnoreCase(method)) {
                ...
                int respuesta = proyectoService.getSrvProyectoPort()
                                  .updateProyecto(idProyecto, idEmpresa, nombre, descripcion, fechaInicio, fechaFinalizacion);
...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet srvUpdateProyecto</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet srvUpdateProyecto at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
        }
    }
