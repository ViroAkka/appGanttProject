...
public class srvUpdateUsuario extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if ("POST".equalsIgnoreCase(method)) {
                ...
                int respuesta = usuarioService.getSrvUsuarioPort()
                                   .updateUsuario(idUsuario, idEmpresa, nombre, apellido, email, contraseña_hash);
            ...
            else 
            {
                ...
                RequestDispatcher rd = request.getRequestDispatcher("mantenimientoUsuario.jsp");
...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet srvUpdateUsuario</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet srvUpdateUsuario at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
        }
    }
