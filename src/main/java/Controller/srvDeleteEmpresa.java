...
public class srvDeleteEmpresa extends HttpServlet {
...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet srvDeleteEmpresa</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet srvDeleteEmpresa at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
        }
    }
