...
public class srvUpdateTarea extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if ("POST".equalsIgnoreCase(method)) {
                ...
                int respuesta = tareaService.getSrvTareaPort()
                                  .updateTarea(idTarea, idProyecto, nombre, descripcion, fechaInicio, fechaFinalizacion);
...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet srvUpdateTarea</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet srvUpdateTarea at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
        }
    }
