...
public class srvDeleteUsuario extends HttpServlet {
...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet srvDeleteUsuario</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet srvDeleteUsuario at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
        }
    }
