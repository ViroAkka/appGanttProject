        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if ("POST".equalsIgnoreCase(method)) {
                ...
                int respuesta = proyectoService.getSrvProyectoPort()
                                  .insertProyecto(idEmpresa, nombre, descripcion, fechaInicio, fechaFinalizacion);
                ...
                response.sendRedirect("newProyecto.jsp");
            } else {
                // Si es GET simplemente mostramos la página
                RequestDispatcher rd = request.getRequestDispatcher("newProyecto.jsp");
